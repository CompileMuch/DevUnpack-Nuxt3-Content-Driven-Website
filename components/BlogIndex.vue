    ...
    <section class="pt-12 sm:pt-16 lg:pt-20 bg-gray-50">
        <div class='max-w-2xl px-4 mx-auto sm:px-6 lg:px-8 lg:max-w-screen-2xl lg:flex lg:items-start'>
            ...
            <div class='mt-12 sm:mt-16 lg:mt-0 lg:ml-12 lg:w-1/2 xl:ml-16'>
                <h3
                    class="pb-2.5 text-2xl font-medium text-gray-900 border-b border-gray-300/70 relative before:content-[''] before:left-0 before:w-24 before:h-px before:-bottom-px before:bg-blue-600 before:absolute">
                    Recent stories</h3>
